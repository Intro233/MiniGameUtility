...
namespace Framework.Audio
{
    ...
    public class AudioManager : SingleTonMonoBase<AudioManager>
    {
        ...
        {
            return _backgroundAudio.isPlaying;
        }
        ...
        public void PauseBackgroundMusic(bool isGradual = false)
        {
            if (isGradual)
            {
        ...
        /// </summary>
        /// <param name="isGradual">是否渐进式</param>
        public void UnPauseBackgroundMusic(bool isGradual = false)
        {
            if (isGradual)
            {
        ...
        /// </summary>
        /// <param name="isGradual">是否渐进式</param>
        public void PauseSingleSound(bool isGradual = false)
        {
            if (isGradual)
            {
        ...
        /// </summary>
        /// <param name="isGradual">是否渐进式</param>
        public void UnPauseSingleSound(bool isGradual = false)
        {
            if (isGradual)
            {
        ...
        /// <param name="attachTarget">附加目标</param>
        /// <param name="isGradual">是否渐进式</param>
        public void PauseWorldSound(GameObject attachTarget, bool isGradual = false)
        {
            if (_worldAudios.ContainsKey(attachTarget))
            {
                AudioSource audio = _worldAudios[attachTarget];
        ...
        /// <param name="attachTarget">附加目标</param>
        /// <param name="isGradual">是否渐进式</param>
        public void UnPauseWorldSound(GameObject attachTarget, bool isGradual = false)
        {
            if (_worldAudios.ContainsKey(attachTarget))
            {
                AudioSource audio = _worldAudios[attachTarget];
